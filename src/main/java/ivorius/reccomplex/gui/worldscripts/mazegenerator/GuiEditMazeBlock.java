...
{
    TableDataSourceWorldScriptMazeGenerator structureDataSource;
    TileEntityMazeGenerator tileEntity;

    public GuiEditMazeBlock(TileEntityMazeGenerator structureGenerator)
    {
        GuiTable structureGenProperties = new GuiTable(this, structureDataSource = new TableDataSourceWorldScriptMazeGenerator(structureGenerator.script, this, this));
