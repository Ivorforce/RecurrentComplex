...
{
    TileEntityStructureGenerator tileEntity;
    ...
    {
        GuiTable structureGenProperties = new GuiTable(this, structureDataSource = new TableDataSourceStructureBlock(structureGenerator.script, this, this));
