...
import ivorius.structuregen.blocks.GeneratingTileEntity;
...
import ivorius.structuregen.ivtoolkit.blocks.IvBlockCollection;
...
public class GenericStructureInfo implements StructureInfo, Cloneable
{
    ...
    public static GenericStructureInfo createDefaultStructure()
    {
        ...
        genericStructureInfo.blockTransformers.add(new BlockTransformerNatural(SGBlocks.naturalFloor, 0));
    ...
    private void generate(World world, Random random, BlockCoord origin, int layer, AxisAlignedTransform2D transform, boolean asSource)
    {
        ...
        {
            StructureGen.logger.warn("Structure generated with over " + MAX_GENERATING_LAYERS + " layers; most likely infinite loop!");
        }
    }
    ...
    public static class Serializer implements JsonDeserializer<GenericStructureInfo>, JsonSerializer<GenericStructureInfo>
    {
        public GenericStructureInfo deserialize(JsonElement jsonElement, Type par2Type, JsonDeserializationContext context)
        {
            ...
            else
            {
                ...
                StructureGen.logger.warn("Structure JSON missing 'version', using latest (" + getClass() + ")");
            }
            ...
            {
                StructureGen.logger.warn("Structure JSON missing 'generationBiomes'!");
            }
            ...
            {
                StructureGen.logger.warn("Structure JSON missing 'generationY'! Using 'surface'!");
        ...
        public JsonElement serialize(GenericStructureInfo structureInfo, Type par2Type, JsonSerializationContext context)
        {
            ...
            if (!StructureGen.USE_ZIP_FOR_STRUCTURE_FILES && structureInfo.worldDataCompound != null)
            {
